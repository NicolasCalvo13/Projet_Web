...
public function switchToCompany(): void {
        if (session_status() === PHP_SESSION_NONE) {
            session_start();
        }
        
        // On vide et détruit la session actuelle (déconnecte l'étudiant s'il y en a un)
        session_unset();
        session_destroy();

        // On le renvoie vers la bonne page de connexion entreprise
